...
async function seedDatabase() {
  ...
  try {
    ...
    await connection.query(`
      ...
      (2, 'Estadio Municipal de Umbrete (Umbrete CF)', 'futbol11', 'Campo de césped artificial', 'Calle Estadio, s/n, 41806', 'Umbrete, Sevilla', 40.00, JSON_ARRAY('/images/equipos/umbrete/umbrete-logo.jpg', '/images/equipos/umbrete/umbrete-campo.jpg', '/images/equipos/umbrete/umbrete-campo2.jpg', '/images/equipos/umbrete/umbrete-vestuario.jpg')),
